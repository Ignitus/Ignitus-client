      ...
      <div className="container _container-custom p-5">
        <div className="row shadow">
          <div className="col-md-6 p-0 container-image">
            <img className="img-fluid _img-login d-block" src={loginImg} alt="" />
          ...
          <div className="col-md-6  _container-form ">
            <div className="my-4">
              <img className="img-fluid _img mx-auto d-block" src={logo} alt="" />
            </div>
            <form>
              ...
              <div className="mb-4">
                <button type="button" className="btn btn-primary mx-auto btn-block">
